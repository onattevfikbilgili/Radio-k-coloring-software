...
#to run the programm type $./mixed FILENAME k
#in your shell where FILENAME is the name of the file where the graph is stored, and k is a natural number greater than 0
g++ -I./include -o mixed main.cpp graph.cpp kgraph.cpp coloring.cpp sp1.cpp mixed.cpp val_col_check.cpp -L./lib -lilocplex -lconcert -lcplex -lm -lpthread
